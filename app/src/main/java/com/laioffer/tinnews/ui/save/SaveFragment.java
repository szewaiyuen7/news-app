...
public class SaveFragment extends Fragment {
    ...
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) { // bundle is kind of like a hashmap, allow cross-process read, each activity is a read
